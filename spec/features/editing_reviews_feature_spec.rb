...
describe "editing reviews" do
  ...
  before(:each) do
    ...
    restaurant.reviews << Review.create(name: "Wilbur", body: "The worst sushi in town. The sushi is awful. I hate this sushi is the wost thing ever", ratings: 2, user: user)
    visit '/restaurants/3'
  end
  ...
  it "should be able to edit reviews" do
    ...
    fill_in('Review', with: "The second best sushi in town. The sushi her is amazing. I love this sushi is the best thing ever")
